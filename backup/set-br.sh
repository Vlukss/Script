#!/bin/bash
# My Telegram : https://t.me/mannnn_07
# ==========================================
# Color
RED='\033[0;31m'
NC='\033[0m'
...
echo -e "${NC}${LIGHT}Facebook : https://m.facebook.com/Wak vluks"
echo -e "${NC}${LIGHT}WhatsApp : 087854543721"
echo -e "${NC}${LIGHT}WhatsApp : 085162883721"
echo -e "${NC}${LIGHT}Telegram : https://t.me/mannnn_07"
echo -e "${NC}${LIGHT}Telegram : https;//t.me/mannnn_07"
exit 0
fi
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/Vlukss/Script/main/backup"
